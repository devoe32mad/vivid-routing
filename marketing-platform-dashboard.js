...
function buildPlatforms({scope,range,campaigns,squareStatus,googleEvidence,googleEnabled,googleAutoSync=true,metaEvidence,metaEnabled=false,metaAutoSync=true,linkedinEvidence,linkedinEnabled=false,linkedinAutoSync=true}) {
...
module.exports={buildPlatforms,platformCard,renderPlatformDetail,platformStyle,dashboardHref,googleMetrics,metaMetrics,linkedinMetrics};
