...
app.post("/admin/new-campaign", async (req, res) => {
  try {
    await q(`INSERT INTO campaigns (name,advertiser,campaign_url,avg_customer_value,conversion_rate,is_deal_of_day,user_id,) VALUES ($1,$2,$3,$4,$5,$6,$7)`,Number(req.body.user_id),[req.body.name || "", req.body.advertiser || "", req.body.campaign_url || "", Number(req.body.avg_customer_value || 50), Number(req.body.conversion_rate || 10), req.body.is_deal_of_day === "on"]);
